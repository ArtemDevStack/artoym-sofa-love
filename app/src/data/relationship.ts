...
export const artifacts: Artifact[] = [
  ...
  { id: "a-film", label: "наш кинематограф", value: "турецкие мелодрамы и ужастики", note: "любим смотреть вместе", tilt: 2 },
  ...
  { id: "a-family", label: "родные и близкие", value: "сёстры Алина и Настя, подруга Алина", note: "все самые классные!", tilt: -3 },
...
export const reasons: LoveReason[] = [
  { id: "r1", text: "За то, как ты злишься на меня, когда что-то не так — но даже тогда остаёшься самой милой." },
  { id: "r2", text: "За наши душевные разговоры до самого утра." },
  { id: "r3", text: "За твои шикарные карие глаза и длинные ресницы, в которых можно утонуть." },
  { id: "r4", text: "За то, как прекрасно ты ведёшь хозяйство по дому и создаёшь настоящий уют." },
  { id: "r5", text: "За то, что ты веришь в меня больше, чем я сам." },
  { id: "r6", text: "За то, что ради тебя я хочу меняться, делать и совершать поступки." },
  { id: "r7", text: "За то, как ты искренне и невероятно сильном любишь меня." },
  { id: "r8", text: "За то, что ты — мой самый родной и прекрасный человек." },
];
