...
export const timeline: TimelineEvent[] = [
  {
    ...
    title: "Знакомство",
    description:
      "Случайная встреча 22 марта. Мы заговорили так спонтанно, и я сразу почувствовал что-то невероятно родное и приятное. Всё, что было до — стало просто прологом.",
