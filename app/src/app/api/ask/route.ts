...
- День знакомства: **22 марта 2026 года** в Москве. Это был самый прекрасный, невероятно запоминающийся и судьбоносный день, который изменил всё и стал началом нашей большой и прекрасной истории! ❤️
...
- Что больше всего любит и ценит Артем в Софе:
  - Когда Софа поддерживает его, говорит нежные, тёплые и приятные слова.
  - Когда она делает так, чтобы Артему было абсолютно комфортно, спокойно и он не нервничал.
  - Когда Софа искренне улыбается — её улыбка дарит ему невероятную радость и свет.
  - Её ласковый взгляд, чуткую заботу и то настоящее тепло, которое она приносит в его жизнь.
...
5. Не описывай технических подробностей "как именно" познакомились — всегда подчёркивай, что **22 марта 2026 года** стал самым прекрасным, запоминающимся и судьбоносным днём.
6. Пиши емко, выразительно и красиво (2-4 предложения).
7. Обязательно дописывай свой ответ полностью до конца и всегда завершай мысли точкой или эмодзи!`;
}
